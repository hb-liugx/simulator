...
public class PredefinedRESTCommandSC extends PredefinedRESTCommand {

	private static final long serialVersionUID = 9120308691016471941L;
	/*
	 * [{config1},{config2},{config3},...]
	 * config1 = {id:id,...,ds_list:[1,2,3,..]}
	 */
	@Override 
